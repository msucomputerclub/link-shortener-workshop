...
!(function (e, t) {
  ...
  var P = function () {
    ...
    W = function (e, t) {
      if ("object" !== (void 0 === e ? "undefined" : j(e)) || "function" != typeof e.createPolicy)
        return null;
      var n = null;
      t.currentScript &&
  ...
  return (function e() {
    ...
    if (((n.version = "2.1.1"), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
    ...
    var ie = N,
      ...
      Ye = function (e) {
        ...
        return ("noscript" !== r && "noembed" !== r) || !v(/<\/no(script|embed)/i, e.innerHTML)
          ? (Ae &&
              3 === e.nodeType &&
              ((t = e.textContent),
              (t = y(t, ie, " ")),
              (t = y(t, ae, " ")),
              e.textContent !== t &&
                (f(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
    ...
    return (
      (n.sanitize = function (e, r) {
        ...
        if ((Se || Ue(r), (n.removed = []), "string" == typeof e && (Oe = !1), Oe));
          ...
          (1 === (l = (i = Be("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType &&
            "BODY" === l.nodeName) ||
          "HTML" === l.nodeName
            ? (i = l)
            : i.appendChild(l);
        ...
        if (_e) {
          if (De) for (d = te.call(i.ownerDocument); i.firstChild; ) d.appendChild(i.firstChild);
          else d = i;
